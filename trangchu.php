	...
	while ($row=mysqli_fetch_array($thucthi))
	{
        ...
        <table>
        	<tr>
                ...
                <a href="#"><img src="trangchu/img/mua ngay.gif" width="178" height="30"></a><a href="#"><img src="trangchu/img/chitiet.jpg" width="144" height="30" style="padding-left:20px"></a></td>
            </tr>
			 <?php } }?>
        </table>
		</div>
